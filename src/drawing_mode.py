        ...
        while cap.isOpened() and st.session_state.get('run_drawing_mode', False):
            ...
            if latest_result and latest_result.hand_landmarks:
                for hand_landmarks in latest_result.hand_landmarks:
                    ...
                    ring_mcp = hand_landmarks[14] # The joint below the tip

                    curr_x, curr_y = int(index_tip.x * 640), int(index_tip.y * 480)
            
            # 1. Check if the hand is "Open" (Ring finger tip is above its joint)
            # Remember: In images, Y decreases as you go UP.

                    if  ring_tip.y < ring_mcp.y  and index_tip.y < index_mcp.y and middle_tip.y < middle_mcp.y:
                # --- NEUTRAL MODE ---
                        cv2.putText(frame, "NEUTRAL (Hand Closed)", (50, 50), 
                ...
                # 2. Hand is open, now decide between DRAW and ERASE
                    ...
                    # --- ERASING MODE ---
                            ...
                            cv2.putText(frame, "ERASING", (curr_x + 35, curr_y), 
                    ...
                    # --- DRAWING MODE ---
                            ...
                            cv2.putText(frame, "DRAWING", (curr_x + 15, curr_y), 
